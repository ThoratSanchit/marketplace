...
const Footer = () => {
  const { name, description, navigation, social } = siteConfig
        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <div className="social-links">
              ...
              <a href={social.facebook} className="social-link" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-section">
            <h4>Support</h4>
            <ul className="footer-links">
              {navigation.footer.support.map((link, index) => (
                <li key={index}><a href={link.href}>{link.name}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div className="footer-section">
            <h4>Newsletter</h4>
            <p>Stay updated with the latest projects and offers</p>
